  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  MotionPlanner(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~MotionPlanner() override;
 ...
 protected:
  ...
  /*!
   */
  RTC::InPort<RTC::TimedLong> m_commandIn;
  ...
  RTC::TimedDoubleSeq m_dynamixel_pose;
  /*!
   */
  RTC::OutPort<RTC::TimedDoubleSeq> m_dynamixel_poseOut;
  RTC::TimedVelocity2D m_wheel_velocity;
  /*!
   */
  RTC::OutPort<RTC::TimedVelocity2D> m_wheel_velocityOut;
  RTC::TimedLong m_motion_state;
  /*!
   */
  RTC::OutPort<RTC::TimedLong> m_motion_stateOut;
 ...
 private:
  ...
  double GRIPPER_NORMAL_ANGLE;

  double BASE_NORMAL_ANGLE;
};


extern "C"
{
  DLL_EXPORT void MotionPlannerInit(RTC::Manager* manager);
};
